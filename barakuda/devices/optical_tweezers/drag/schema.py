...
class DragAnalysisConfig:
    ...
    steady_window_override_start_rel_s: float | None = None
    steady_window_override_end_rel_s: float | None = None
    steady_window_override_source: str | None = None
...
class DragAnalysisResult:
    ...
    stage_trace_sample_count: int | None = None
    stage_trace_velocity_sample_count: int | None = None
    stage_trace_position_sample_count: int | None = None
    stage_trace_usable_for_windowing: bool | None = None
    steady_window_mode: str | None = None
    steady_window_override_source: str | None = None
    steady_window_override_start_rel_s: float | None = None
    steady_window_override_end_rel_s: float | None = None
    auto_window_recovered: bool | None = None
    auto_window_guard_chain: list[float] = field(default_factory=list)
    auto_window_guard_used_s: float | None = None
    auto_window_recovery_reason: str | None = None
    # Trajectory chain audit (default: generated by Drag tracking on this RAW; reuse is non-default)
