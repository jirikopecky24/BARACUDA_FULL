...
def drag_result_to_dict(result: DragAnalysisResult) -> dict[str, Any]:
    ...
    d: dict[str, Any] = {
        ...
        "drag_force_n_se": result.drag_force_n_se,
        "kappa_n_per_m": result.kappa_n_per_m,
        "kappa_n_per_m_se": result.kappa_n_per_m_se,
        "kappa_pn_per_um": result.kappa_pn_per_um,
        "kappa_pn_per_um_se": result.kappa_pn_per_um_se,
        "eta_pa_s": result.eta_pa_s,
        "eta_pa_s_se": result.eta_pa_s_se,
        "offset_um_se": result.offset_um_se,
        "actual_speed_um_s_se": result.actual_speed_um_s_se,
        ...
        "t_first_s": result.t_first_s,
        "t_last_s": result.t_last_s,
        ...
        "steady_start_marker_source": result.steady_start_marker_source,
        "steady_end_marker_source": result.steady_end_marker_source,
        "deceleration_start_stage_s": result.deceleration_start_stage_s,
        "deceleration_start_video_s": result.deceleration_start_video_s,
        "deceleration_start_source": result.deceleration_start_source,
        "steady_state_start_stage_s": result.steady_state_start_stage_s,
        "steady_state_start_video_s": result.steady_state_start_video_s,
        ...
        "stage_trace_sample_count": result.stage_trace_sample_count,
        "stage_trace_velocity_sample_count": result.stage_trace_velocity_sample_count,
        "stage_trace_position_sample_count": result.stage_trace_position_sample_count,
        "stage_trace_usable_for_windowing": result.stage_trace_usable_for_windowing,
        "steady_window_mode": result.steady_window_mode,
        "steady_window_override_source": result.steady_window_override_source,
        "steady_window_override_start_rel_s": result.steady_window_override_start_rel_s,
        "steady_window_override_end_rel_s": result.steady_window_override_end_rel_s,
        "auto_window_recovered": result.auto_window_recovered,
        "auto_window_guard_chain": list(result.auto_window_guard_chain),
        "auto_window_guard_used_s": result.auto_window_guard_used_s,
        "auto_window_recovery_reason": result.auto_window_recovery_reason,
