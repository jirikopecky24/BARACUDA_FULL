...
class DatasetPanel(QWidget):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self._btn_select_all.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        ...
        self._btn_remove_selected.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
